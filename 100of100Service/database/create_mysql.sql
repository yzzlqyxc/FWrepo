...
INSERT INTO employees (employee_id, organization_id, department_id, name, position, hire_date, salary, contact_info) VALUES
(20001, 2, 20001, 'Alice Johnson', 'Research Scientist', '2018-03-10', 90000.00, '{"email": "alice.johnson@beta.com", "phone": "555-555-5555"}'),
(20002, 2, 20002, 'Bob Brown', 'Sales Associate', '2021-07-22', 60000.00, '{"email": "bob.brown@beta.com", "phone": "444-444-4444"}');
